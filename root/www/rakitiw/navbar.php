    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item <?php if ($url === 'index.php') echo 'active'; ?>">
                <a class="nav-link" href="index.php"><i class="fa fa-home"></i> Modem Rakitan <span class="sr-only">(current)</span></a>
            </li>
            ...
            <li class="nav-item <?php if ($url === 'pengaturan.php') echo 'active'; ?>">
