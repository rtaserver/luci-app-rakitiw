...
finish(){
    ...
    echo -e "\e[1;33mAtau Membuka Manual Di Tab Baru : 192.168.1.1/rakitiw\e[0m"
    echo ""
...
download_files()
{
    ...
    rakitiw_api="https://api.github.com/repos/rtaserver/luci-app-rakitiw/releases"
    rakitiw_file="luci-app-rakitiw"
    if [ -f "$DIR/rakitiw.ipk" ]; then
        rm -f $DIR/rakitiw.ipk
    fi
    if [ $1 == "1" ]; then
...
while true; do
    echo "============================================"
    echo "Download Dan Install IPK Rakitiw."
    echo ""
